...
payment.get(
  "/payment_method_list",
  checkFirebaseToken,
  paymentController.getSavedPaymentMethodList
);
...
payment.delete(
  ...
  checkFirebaseToken,
  paymentController.deletePaymentMethodById
);
...
payment.post(
  ...
  checkFirebaseToken,
  paymentController.payWithSavedPaymentMethod
);
...
payment.post(
  "/pay_with_intent",
  checkFirebaseToken,
  paymentController.payWithPaymentIntent
);

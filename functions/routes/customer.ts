...
customer.get(
  "/reward_history",
  checkFirebaseToken,
  customerController.getRewardHistory
);

// ADDRESS
// calculate the delivery charge
customer.post(
  "/address/calc_delivery",
  checkFirebaseToken,
  customerController.calculateDelivery
);

// update apt and business
customer.patch(
  "/address/apt_business",
  checkFirebaseToken,
  customerController.updateAptAndBusiness
);
...
customer.delete(
  "/address/apt_business",
  checkFirebaseToken,
  customerController.removeAptAndBusiness
);
